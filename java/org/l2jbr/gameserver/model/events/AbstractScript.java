...
import org.l2jbr.gameserver.model.events.listeners.AnnotationEventListener;
import org.l2jbr.gameserver.model.events.listeners.ConsumerEventListener;
import org.l2jbr.gameserver.model.events.listeners.DummyEventListener;
import org.l2jbr.gameserver.model.events.listeners.FunctionEventListener;
import org.l2jbr.gameserver.model.events.listeners.RunnableEventListener;
...
import org.l2jbr.gameserver.model.events.timers.IEventTimerCancel;
import org.l2jbr.gameserver.model.events.timers.IEventTimerEvent;
...
import org.l2jbr.gameserver.network.serverpackets.SpecialCamera;
import org.l2jbr.gameserver.network.serverpackets.SystemMessage;
import org.l2jbr.gameserver.scripting.ManagedScript;
...
public abstract class AbstractScript extends ManagedScript implements IEventTimerEvent<String>, IEventTimerCancel<String>
{
	...
	/**
	 * Provides instant callback operation when {@link org.l2jbr.gameserver.model.actor.Creature} Enters on a {@link ZoneType}.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	...
	/**
	 * Provides instant callback operation when {@link org.l2jbr.gameserver.model.actor.Creature} Exits on a {@link ZoneType}.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	...
	/**
	 * Provides instant callback operation when {@link org.l2jbr.gameserver.model.actor.instance.TrapInstance} acts.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	 ...
	 * Use this method instead of importing {@link org.l2jbr.commons.util.Rnd} utility.
	...
	/**
	 * @return the number of ticks from the {@link org.l2jbr.gameserver.GameTimeController}.
	 */
