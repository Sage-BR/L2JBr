...
import org.l2jbr.gameserver.model.base.PlayerState;
import org.l2jbr.gameserver.model.conditions.Condition;
import org.l2jbr.gameserver.model.conditions.ConditionCategoryType;
import org.l2jbr.gameserver.model.conditions.ConditionChangeWeapon;
import org.l2jbr.gameserver.model.conditions.ConditionGameChance;
import org.l2jbr.gameserver.model.conditions.ConditionGameTime;
import org.l2jbr.gameserver.model.conditions.ConditionGameTime.CheckGameTime;
import org.l2jbr.gameserver.model.conditions.ConditionLogicAnd;
import org.l2jbr.gameserver.model.conditions.ConditionLogicNot;
import org.l2jbr.gameserver.model.conditions.ConditionLogicOr;
import org.l2jbr.gameserver.model.conditions.ConditionMinDistance;
import org.l2jbr.gameserver.model.conditions.ConditionMinimumVitalityPoints;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerActiveEffectId;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerActiveSkillId;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerAgathionId;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerCallPc;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerCanCreateBase;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerCanEscape;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerCanRefuelAirship;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerCanResurrect;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerCanSummonPet;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerCanSummonServitor;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerCanSummonSiegeGolem;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerCanSweep;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerCanSwitchSubclass;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerCanTakeCastle;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerCanTakeFort;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerCanTransform;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerCanUntransform;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerCharges;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerCheckAbnormal;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerClassIdRestriction;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerCloakStatus;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerCp;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerDualclass;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerFlyMounted;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerHasCastle;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerHasClanHall;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerHasFort;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerHasFreeSummonPoints;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerHasFreeTeleportBookmarkSlots;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerHasPet;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerHasSummon;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerHp;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerImmobile;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerInInstance;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerInsideZoneId;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerInstanceId;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerInvSize;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerIsClanLeader;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerIsHero;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerIsInCombat;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerIsOnSide;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerIsPvpFlagged;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerLandingZone;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerLevel;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerLevelRange;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerMp;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerPkCount;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerPledgeClass;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerRace;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerRangeFromNpc;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerRangeFromSummonedNpc;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerServitorNpcId;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerSex;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerSiegeSide;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerSouls;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerState;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerSubclass;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerTransformationId;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerVehicleMounted;
import org.l2jbr.gameserver.model.conditions.ConditionPlayerWeight;
import org.l2jbr.gameserver.model.conditions.ConditionSiegeZone;
import org.l2jbr.gameserver.model.conditions.ConditionSlotItemId;
import org.l2jbr.gameserver.model.conditions.ConditionTargetAbnormalType;
import org.l2jbr.gameserver.model.conditions.ConditionTargetActiveEffectId;
import org.l2jbr.gameserver.model.conditions.ConditionTargetActiveSkillId;
import org.l2jbr.gameserver.model.conditions.ConditionTargetAggro;
import org.l2jbr.gameserver.model.conditions.ConditionTargetCheckCrtEffect;
import org.l2jbr.gameserver.model.conditions.ConditionTargetClassIdRestriction;
import org.l2jbr.gameserver.model.conditions.ConditionTargetInvSize;
import org.l2jbr.gameserver.model.conditions.ConditionTargetLevel;
import org.l2jbr.gameserver.model.conditions.ConditionTargetLevelRange;
import org.l2jbr.gameserver.model.conditions.ConditionTargetMyPartyExceptMe;
import org.l2jbr.gameserver.model.conditions.ConditionTargetNpcId;
import org.l2jbr.gameserver.model.conditions.ConditionTargetNpcType;
import org.l2jbr.gameserver.model.conditions.ConditionTargetPlayable;
import org.l2jbr.gameserver.model.conditions.ConditionTargetPlayer;
import org.l2jbr.gameserver.model.conditions.ConditionTargetRace;
import org.l2jbr.gameserver.model.conditions.ConditionTargetUsesWeaponKind;
import org.l2jbr.gameserver.model.conditions.ConditionTargetWeight;
import org.l2jbr.gameserver.model.conditions.ConditionUsingItemType;
import org.l2jbr.gameserver.model.conditions.ConditionUsingSkill;
import org.l2jbr.gameserver.model.conditions.ConditionUsingSlotType;
import org.l2jbr.gameserver.model.conditions.ConditionWithSkill;
